# Generated by Django 3.0.2 on 2020-01-17 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deposit_date', models.DateTimeField(default=datetime.datetime(2020, 1, 17, 9, 41, 16, 8101))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default=datetime.datetime(2020, 1, 17, 9, 41, 16, 9060))),
                ('quantity', models.IntegerField()),
                ('crop', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='withdrawals', to='api.Crop')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
